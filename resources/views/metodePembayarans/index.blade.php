    ...
    <div class="container mt-5" id="list-payment">
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded" id="card">
                    <div class="card-body" >
                        <a href="{{ route('metodePembayarans.create') }}" class="btn btn-md  mb-3" id="btn">ADD METHODS</a>
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <th scope="col" id="type1">Nama Metode Pembayaran</th>
        ...
        @forelse($metodePembayarans as $mp)
            <tr>
                ...
                <td>
                    <form action="{{ route('metodePembayarans.destroy', $mp->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus metode ini?');">
                        @csrf
                        @method('DELETE')
                        <a href="{{ route('metodePembayarans.edit', $mp->id) }}" class="btn btn-sm btn-primary" id="edit">EDIT</a>
